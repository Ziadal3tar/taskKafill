...
let navres = document.getElementById('navres');
...
navres.addEventListener('click', closeNavRes);
...
function closeNavRes() {
    let tap = document.getElementById('navResList')
    if (tap.classList.contains('closeNavResList')) {
        tap.classList.remove('closeNavResList')
        
    }else{
        tap.classList.add('closeNavResList')
    }
}